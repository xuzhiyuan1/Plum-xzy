...
export filename_prefix="result_fig14_repro"
...
# solver for n=3 (port 11999)
pkill -9 -f "solver.py" 2>/dev/null || true
sleep 2
python3 ${CURRENT_DIR}/../scripts/solver/solver.py -n 3 > ${CURRENT_DIR}/solver_fig14_n3.log 2>&1 &
sleep 3
